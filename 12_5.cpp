...
//	}
//}
//void 打印折痕(int i,int n,bool down)
//{
//	if (i > n)
//		return;
//	打印折痕(i + 1, n, true);
...
//}
//template<class T>
//TreeNode<T>*& 深入右子树(TreeNode<T>*& node)
//{
//	while (node->left)
//	{
//		node = node->left;
...
//}
//template<class T>
//TreeNode<T>*& 找后继(TreeNode<T>*& tree)
//{
//	if (tree == nullptr)
//		return tree;
//	if (tree->right != nullptr)
//	{
//		return 深入右子树(tree->right);
//	}
//	else
//	{
//		TreeNode<T>* parent = tree->parent;
//		while (parent != nullptr && parent->left != tree)
//		{
//			tree = parent;
...
//int main()
//{
//	vector<int> vec = { 5, 4, 9, 8, 6, 9, 8, 5, 3, 5 };
//	cout<<找局部最小(vec);
//	//折纸(3);
