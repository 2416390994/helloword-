...
//{
//	vector<string> vec0 = {};
//	vector<Tree_Node*> vec1;  //这个数组用来存放的是当前节点的子节点的指针
//	vector<vector<string>> vec2; // 这个二维数组，存放的将会是一些代码和笔记
//};
//void init(Tree_Node& tree)
//{
//	assert(tree.vec0.empty());
//	Tree_Node* ps = new Tree_Node;
//	ps->vec0.push_back("数据结构大作业------数据结构知识点总结");
//}
//void push(Tree_Node& tree,vector<vector<string>>& vec)
//{
...
////////// 窗口大小 //////////
const short ScreenWidth = 1920;
const short ScreenHeight = 1080;
////////// 全局变量 //////////
long ret = 0;
MOUSEMSG msg;
const short gap = 20;
